...
def build_interactive_data_filter(data: pd.DataFrame, key_version: str, big_labels: Optional[Dict[str, Union[str, List[str]]]] = None) -> tuple[pd.DataFrame, Dict[str, Optional[str]]]:
    """
...
def export_settings_to_compare_tab(values_to_export: Dict[str, Optional[str]], version: str) -> None:
